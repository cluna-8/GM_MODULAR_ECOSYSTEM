...
## 🏗️ Arquitectura del Sistema (Los 4 Componentes Principales)

El sistema está dividido en **4 módulos independientes** que trabajan juntos:
...
### 4️⃣ **medical_auditor** (El Guardián de Seguridad)
...
- [ ] Agente de Voz (Audio-to-Text médico)
- [ ] Agente de Resumen (Historias clínicas)
- [ ] Agente de Diagnóstico (Diagnóstico diferencial)
